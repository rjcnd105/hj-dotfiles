...
- Bash
- Glob
argument-hint: <excalidraw-file> [--format=html|svg|png|html+png] [--size=<preset>]
  [--detail=faithful|balanced|simplified] [--audience=engineer|mixed|executive] [--type=<diagram-type>]
  [--variant=light|dark|full] [--output=<path>]
description: Redraw an Excalidraw board as an editorial diagram at a chosen format,
  size, and detail level
---

Redraw the Excalidraw scene at `$1` in this skill's design system, following [`skills/diagram-design/references/import-excalidraw.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/import-excalidraw.md) and [`skills/diagram-design/references/output-spec.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/output-spec.md). Treat those references as the source of truth — don't reimplement the logic here.
...
- Type is chosen from the extracted structure; `--type` forces one of the visual
  types in [`SKILL.md` §3](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/SKILL.md).
