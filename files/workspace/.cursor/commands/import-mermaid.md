...
- Bash
- Glob
argument-hint: <mermaid-file> [--format=html|svg|png|html+png] [--size=<preset>] [--detail=faithful|balanced|simplified]
  [--audience=engineer|mixed|executive] [--type=<diagram-type>] [--diagram=N|all]
  [--variant=light|dark|full] [--output=<path>]
description: Redraw Mermaid as an editorial diagram at a chosen format, size, and
  detail level
---

Redraw the Mermaid source at `$1` in this skill's design system, following [`skills/diagram-design/references/import-mermaid.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/import-mermaid.md) and [`skills/diagram-design/references/output-spec.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/output-spec.md). Treat those references as the source of truth.
