...
The digest is the token-light map from requirement to example. Open `examples/<pattern-id>/index.html` only after a pattern is shortlisted for adaptation, verification, or bug fixing.
