...
- Code kernel: `references/code-kernels.md#layered-shadow-border`.
...
- Code kernel: `references/code-kernels.md#starting-style-popover`.
...
- Code kernel: `references/code-kernels.md#scroll-state-sticky-header`.
...
- Code kernel: `references/code-kernels.md#container-query-card`.
...
- Code kernel: `references/code-kernels.md#anchor-tooltip-popover`.
...
- Code kernel: `references/code-kernels.md#fluid-container-type`.
...
- Code kernel: `references/code-kernels.md#css-if-style-query`.
...
- Code kernel: `references/code-kernels.md#sequential-custom-property-animation`.
...
- Code kernel: `references/code-kernels.md#anchor-function-sidenote`.
...
- Code kernel: `references/code-kernels.md#previous-sibling-has-combinator`.
...
- Code kernel: `references/code-kernels.md#cross-document-view-transition`.
...
- Code kernel: `references/code-kernels.md#scroll-progress-counter-label`.
