...
<!-- Build ID: 4a1db044aa8d -->
<!-- APM Version: 0.28.0 -->

## Files matching `**`

<!-- Source: .apm/instructions/personal-agent-guide.instructions.md -->
...
<!-- End source: .apm/instructions/personal-agent-guide.instructions.md -->

<!-- Source: .apm/packages/rtk-codex/.apm/instructions/rtk.instructions.md -->
# RTK shell output

For summary-friendly high-output shell commands, read and follow this guide
before running them:

@/Users/hj/.codex/RTK.md
<!-- End source: .apm/packages/rtk-codex/.apm/instructions/rtk.instructions.md -->
