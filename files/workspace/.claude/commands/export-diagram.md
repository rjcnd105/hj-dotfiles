...
Export the diagram HTML at `$1` to `.svg` and/or `.png`, following the procedure documented in [`skills/diagram-design/references/export.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/export.md). Treat that reference as the source of truth — don't reimplement the logic here.
