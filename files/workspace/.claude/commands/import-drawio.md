...
- Bash
- Glob
argument-hint: <drawio-file> [--format=html|svg|png|html+png] [--size=<preset>] [--detail=faithful|balanced|simplified]
  [--audience=engineer|mixed|executive] [--type=<diagram-type>] [--page=N|NAME|all]
  [--variant=light|dark|full] [--output=<path>]
description: Redraw a draw.io file as an editorial diagram at a chosen format, size,
  and detail level
---

Redraw the draw.io file at `$1` as a diagram in this skill's design system, following [`skills/diagram-design/references/import-drawio.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/import-drawio.md) and [`skills/diagram-design/references/output-spec.md`](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/references/output-spec.md). Treat those references as the source of truth — don't reimplement the logic here.
...
- Type is chosen from the extracted structure; `--type` forces one of the visual types in
  [`SKILL.md` §3](../../apm_modules/cathrynlavery/diagram-design/.apm/skills/diagram-design/SKILL.md).
