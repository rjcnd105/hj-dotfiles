            ...
            for line in f:
                ...
                try:
                    ...
                    # Flat format (testing / future compatibility)
                        ...
                        if entry["role"] == "user" and is_synthetic_codex_user_message(entry["content"]):
                            continue
                ...
                if "role" in entry and "content" in entry:
                    ...
                    if entry["role"] == "user":
                        ...
                        if isinstance(content, str):
                            if is_synthetic_codex_user_message(content):
                                continue
                            ...
                            content = [
                                ...
                                if not (
                                    ...
                                    and is_synthetic_codex_user_message(block.get("text", ""))
                                )
                            ]
                            if not content:
                                continue
