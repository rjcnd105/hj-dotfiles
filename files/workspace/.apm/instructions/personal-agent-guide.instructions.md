...
- Do not delegate unless the user or an applicable project or skill instruction
  explicitly requests it. When authorized, delegate only independent, bounded
  work. Keep dependent work sequential, and verify the combined result in the
  primary session.
