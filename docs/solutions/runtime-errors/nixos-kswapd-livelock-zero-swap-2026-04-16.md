...
- 2026-04-19 이후 rerank 워크로드는 Docker가 아닌 호스트 systemd `llama-swap`으로 이동 ([`../performance-issues/hindsight-reranker-vulkan-acceleration-2026-04-19.md`](../performance-issues/hindsight-reranker-vulkan-acceleration-2026-04-19.md)) → Docker 동시 기동 RAM peak 계산에서 rerank 슬롯은 제외. embed-prefix-proxy는 여전히 호스트 Python 서비스로 별도 메모리 소비
